...
function PasswordForm() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      } else if (errorCode === 'wrong-password' || error.message?.includes('wrong-password')) {
        errorMessage = 'Incorrect password. Please try again.';
      } else if (errorCode === 'invalid-email' || error.message?.includes('invalid-email')) {
        errorMessage = 'Invalid email address.';
      } else if (errorCode === 'user-disabled' || error.message?.includes('user-disabled')) {
        errorMessage = 'This account has been disabled.';
      } else if (error.message && error.message !== 'Login failed. Please try again.') {
